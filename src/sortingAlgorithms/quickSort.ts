...
// Partition array into 2 halves and recurse on both of these halves
function quickSortBody(
  arr: number[],
  lower: number,
  upper: number,
...
// Partition section of array between lower and upper and return index of pivot
function partition(
  arr: number[],
  lower: number,
  upper: number,
